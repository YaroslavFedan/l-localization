...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Automatically detect the locale from the browser (https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Accept-Language)
    | For example, if the user's browser language is "en" and "en" is active in "supportedLocales",
    | `/about` will be redirected to `/en/about`.
    |
    | If false, or there is no browser language in supportedLocales, the system will take config('app.locale')
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If `hideDefaultLocaleInURL` is true then URL without locale matches the same URL with the default locale.
    | For example, if `en` is the default locale, then `/en/about` and `/about`
    | will be identical.
    |
    | It is recommended to use `hideDefaultLocaleInURL` to avoid duplicate content (SEO).
    |
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    |  Default driver with list supported Locales
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    |  Database driver with list supported Locales
    |--------------------------------------------------------------------------
    */
    'database' => [
        // Specifies the namespace of the "Localizations" class.
        // For example, App\Models\Localization
        'model_namespace' => '',
        // Set the name of the field in the database that contains the list of available locales
        'locale_key' => null,
    ],
    /*
    |--------------------------------------------------------------------------
